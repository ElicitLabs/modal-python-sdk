...
from .resources import modal, users, health, machine, api_keys, inference
from ._streaming import Stream as Stream, AsyncStream as AsyncStream
from ._exceptions import APIStatusError, ElicitLabsError
...
class ElicitLabs(SyncAPIClient):
    ...
    with_raw_response: ElicitLabsWithRawResponse
    with_streaming_response: ElicitLabsWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous ElicitLabs client instance.
        ...
        if base_url is None:
            base_url = os.environ.get("ELICIT_LABS_BASE_URL")
        if base_url is None:
        ...
        self.with_raw_response = ElicitLabsWithRawResponse(self)
        self.with_streaming_response = ElicitLabsWithStreamedResponse(self)
...
class AsyncElicitLabs(AsyncAPIClient):
    ...
    with_raw_response: AsyncElicitLabsWithRawResponse
    with_streaming_response: AsyncElicitLabsWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncElicitLabs client instance.
        ...
        self.with_raw_response = AsyncElicitLabsWithRawResponse(self)
        self.with_streaming_response = AsyncElicitLabsWithStreamedResponse(self)
...
class ElicitLabsWithRawResponse:
    def __init__(self, client: ElicitLabs) -> None:
...
class AsyncElicitLabsWithRawResponse:
    def __init__(self, client: AsyncElicitLabs) -> None:
...
class ElicitLabsWithStreamedResponse:
    def __init__(self, client: ElicitLabs) -> None:
...
class AsyncElicitLabsWithStreamedResponse:
    def __init__(self, client: AsyncElicitLabs) -> None:
